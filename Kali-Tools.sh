...
EOF'
		...
		"Information Gathering")
			sudo apt install -y install -y acccheck ace-voip amap automater braa casefile cdpsnarf cisco-torch cookie-cadger copy-router-config dmitry dnmap dnsenum dnsmap dnsrecon dnstracer dnswalk dotdotpwn enum4linux enumiax exploitdb fierce firewalk fragroute fragrouter ghost-phisher golismero goofile lbd maltego-teeth masscan metagoofil miranda nmap p0f parsero recon-ng set smtp-user-enum snmpcheck sslcaudit sslsplit sslstrip sslyze thc-ipv6 theharvester tlssled twofi urlcrazy wireshark wol-e xplico ismtp intrace hping3 && wget http://www.morningstarsecurity.com/downloads/bing-ip2hosts-0.4.tar.gz && tar -xzvf bing-ip2hosts-0.4.tar.gz && cp bing-ip2hosts-0.4/bing-ip2hosts /usr/local/bin/
			echo ''
			echo 'Ok, per Information Gathering sei a posto, proseguiamo!'
			echo -e "\e[1;31mTi ricordo le opzioni: 1.Aggiungi i Repo di Kali Linux; 2.Information Gathering; 3.Vulnerability Analysis; 4.Wireless Attacks; 5.Web Applications; 6.Sniffing & Spoofing; 7.Maintaining Access; 8.Reporting Tools; 9.Exploitation Tools; 10.Forensics Tools; 11.Stress Testing; 12.Password Attack; 13.Reverse Engineering; 14.Hardware Hacking; 15.Extra; 16.Installa tutto; 17.Ripristina il Source.List col Mirror originale; 18.Termina\e[0m"
		;;
		"Vulnerability Analysis")
			sudo apt install install -y bbqsql bed cisco-auditing-tool cisco-global-exploiter cisco-ocs cisco-torch copy-router-config doona dotdotpwn greenbone-security-assistant hexorbase jsql lynis nmap ohrwurm openvas-cli openvas-manager openvas-scanner oscanner powerfuzzer sfuzz sidguesser siparmyknife sqlmap sqlninja sqlsus thc-ipv6 tnscmd10g unix-privesc-check yersinia
			echo ''
		...
		;;
		"Exploitation Tools")
			sudo apt install -y install -y armitage backdoor-factory cisco-auditing-tool cisco-global-exploiter cisco-ocs cisco-torch crackle jboss-autopwn linux-exploit-suggester maltego-teeth set shellnoob sqlmap thc-ipv6 yersinia beef-xss
			echo ''
			echo 'Exploitation Tools installati, proseguiamo!'
			echo -e "\e[1;31mTi ricordo le opzioni: 1.Aggiungi i Repo di Kali Linux; 2.Information Gathering; 3.Vulnerability Analysis; 4.Wireless Attacks; 5.Web Applications; 6.Sniffing & Spoofing; 7.Maintaining Access; 8.Reporting Tools; 9.Exploitation Tools; 10.Forensics Tools; 11.Stress Testing; 12.Password Attack; 13.Reverse Engineering; 14.Hardware Hacking; 15.Extra; 16.Installa tutto; 17.Ripristina il Source.List col Mirror originale; 18.Termina\e[0m"
		;;
		"Forensics Tools")
			sudo apt install -y install -y binwalk bulk-extractor chntpw cuckoo dc3dd ddrescue dumpzilla extundelete foremost galleta guymager iphone-backup-analyzer p0f pdf-parser pdfid pdgmail peepdf volatility xplico
			echo ''
			echo 'Forensics Tools installati, proseguiamo!'
			echo -e "\e[1;31mTi ricordo le opzioni: 1.Aggiungi i Repo di Kali Linux; 2.Information Gathering; 3.Vulnerability Analysis; 4.Wireless Attacks; 5.Web Applications; 6.Sniffing & Spoofing; 7.Maintaining Access; 8.Reporting Tools; 9.Exploitation Tools; 10.Forensics Tools; 11.Stress Testing; 12.Password Attack; 13.Reverse Engineering; 14.Hardware Hacking; 15.Extra; 16.Installa tutto; 17.Ripristina il Source.List col Mirror originale; 18.Termina\e[0m"
		;;
		"Stress Testing")
		sudo apt install -y install -y dhcpig funkload iaxflood inviteflood ipv6-toolkit mdk3 reaver rtpflood slowhttptest t50 termineter thc-ipv6 thc-ssl-dos
			echo ''
			echo 'Tools per Stress testing installati, proseguiamo!'
			echo -e "\e[1;31mTi ricordo le opzioni: 1.Aggiungi i Repo di Kali Linux; 2.Information Gathering; 3.Vulnerability Analysis; 4.Wireless Attacks; 5.Web Applications; 6.Sniffing & Spoofing; 7.Maintaining Access; 8.Reporting Tools; 9.Exploitation Tools; 10.Forensics Tools; 11.Stress Testing; 12.Password Attack; 13.Reverse Engineering; 14.Hardware Hacking; 15.Extra; 16.Installa tutto; 17.Ripristina il Source.List col Mirror originale; 18.Termina\e[0m"
		;;
		"Password Attack")
			sudo apt install -y install -y acccheck burpsuite cewl chntpw cisco-auditing-tool cmospwd creddump crunch findmyhash gpp-decrypt hash-identifier hexorbase john johnny keimpx maltego-teeth maskprocessor multiforcer ncrack oclgausscrack pack patator polenum rainbowcrack rcracki-mt rsmangler statsprocessor thc-pptp-bruter truecrack webscarab wordlists zaproxy
				echo ''
				echo 'Software di Password Attack installati, proseguiamo!'
				echo -e "\e[1;31mTi ricordo le opzioni: 1.Aggiungi i Repo di Kali Linux; 2.Information Gathering; 3.Vulnerability Analysis; 4.Wireless Attacks; 5.Web Applications; 6.Sniffing & Spoofing; 7.Maintaining Access; 8.Reporting Tools; 9.Exploitation Tools; 10.Forensics Tools; 11.Stress Testing; 12.Password Attack; 13.Reverse Engineering; 14.Hardware Hacking; 15.Extra; 16.Installa tutto; 17.Ripristina il Source.List col Mirror originale; 18.Termina\e[0m"
		;;
		"Reverse Engineering")
			sudo apt install -y install -y apktool dex2jar python-diStorm3 edb-debugger jad javasnoop JD OllyDbg smali Valgrind YARA
			echo ''
			echo 'Software di Reverse Engineering installato, proseguiamo!'
			echo -e "\e[1;31mTi ricordo le opzioni: 1.Aggiungi i Repo di Kali Linux; 2.Information Gathering; 3.Vulnerability Analysis; 4.Wireless Attacks; 5.Web Applications; 6.Sniffing & Spoofing; 7.Maintaining Access; 8.Reporting Tools; 9.Exploitation Tools; 10.Forensics Tools; 11.Stress Testing; 12.Password Attack; 13.Reverse Engineering; 14.Hardware Hacking; 15.Extra; 16.Installa tutto; 17.Ripristina il Source.List col Mirror originale; 18.Termina\e[0m"
		;;
		"Hardware Hacking")
			sudo apt install -y install -y android-sdk apktool arduino dex2jar sakis3g smali
			echo ''
